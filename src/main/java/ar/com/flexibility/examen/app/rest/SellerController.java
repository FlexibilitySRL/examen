...
public class SellerController extends CustomController {
	...
	public ResponseEntity<Object> deleteSeller(@ApiParam("Seller identifier") @PathVariable String identifier) {
		try {
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Successful operation"),
			@ApiResponse(code = 500, message = "Internal Server Error"), })
	public ResponseEntity<Object> getSeller(@ApiParam("Seller identifier") @PathVariable String identifier) {
		try {
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Successful operation"),
			@ApiResponse(code = 500, message = "Internal Server Error"), })
	public ResponseEntity<Object> newSeller(@ApiParam("Seller data") @RequestBody SellerApi seller) {
		try {
			// To save a new seller
			this.sellerService.save(seller.getIdentifier(), seller.getName(), seller.getSurname());
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Successful operation"),
			@ApiResponse(code = 500, message = "Internal Server Error"), })
	public ResponseEntity<Object> updateSeller(@ApiParam("Seller data") @RequestBody SellerApi seller,
			@ApiParam("Current seller identifier") @PathVariable String identifier) {
		try {
			// To update a seller
			this.sellerService.update(identifier, seller.getIdentifier(), seller.getName(), seller.getSurname());
