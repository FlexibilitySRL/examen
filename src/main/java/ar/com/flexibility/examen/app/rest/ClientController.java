...
public class ClientController extends CustomController {
	...
	public ResponseEntity<Object> deleteClient(@ApiParam("Client identifier") @PathVariable String identifier) {
		try {
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Successful operation"),
			@ApiResponse(code = 500, message = "Internal Server Error"), })
	public ResponseEntity<Object> getClient(@ApiParam("Client identifier") @PathVariable String identifier) {
		try {
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Successful operation"),
			@ApiResponse(code = 500, message = "Internal Server Error"), })
	public ResponseEntity<Object> newClient(@ApiParam("Client data") @RequestBody ClientApi client) {
		try {
			// To save a new client
			this.clientService.save(client.getIdentifier(), client.getName(), client.getSurname());
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Successful operation"),
			@ApiResponse(code = 500, message = "Internal Server Error"), })
	public ResponseEntity<Object> updateClient(@ApiParam("Client data") @RequestBody ClientApi client,
			@ApiParam("Current client identifier") @PathVariable String identifier) {
		try {
			// To update a client
			this.clientService.update(identifier, client.getIdentifier(), client.getName(), client.getSurname());
