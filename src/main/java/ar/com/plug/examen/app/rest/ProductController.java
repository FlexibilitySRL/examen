...
public class ProductController {
    ...
    @Autowired
    public ProductController(ProcessCustomerService processCustomerService) {
    ...
    private static Boolean getActiveRequired(@RequestBody ObjectNode objectNode) {
        ...
        if (null == aBoolean) {
            throw new ResponseStatusException(HttpStatus.UNPROCESSABLE_ENTITY, ProductController.ACTIVE_REQUIRED_MESSAGE);
        }
        return aBoolean;
    }
