...
public class ProductServiceImpl implements ProductService {
   ...
   * (non-Javadoc)
   *
   * @see ar.com.plug.examen.domain.service.ProductService#findByIdChecked(Long) ()
   */
  @Override
  public ProductApi findByIdChecked(Long id) throws GenericNotFoundException {
   ...
   * (non-Javadoc)
   *
   * @see ar.com.plug.examen.domain.service.ProductService#getProductsWithStock(List<ProductStockApi>)
   * ()
   */
  @Override
