...
import ar.com.flexibility.examen.app.rest.vm.KeyAndPasswordVM;
...
import ar.com.flexibility.examen.repository.AuthorityRepository;
...
public class AccountControllerIntTest {
    ...
    public void testSaveAccount() throws Exception {
        ...
        userApi.setLogin("not-used");
        userApi.setFirstName("firstname");
        userApi.setLastName("lastname");
        userApi.setEmail("save-account@example.com");
        userApi.setActivated(false);
        userApi.setImageUrl("http://placehold.it/50x50");
        userApi.setLangKey(Constants.DEFAULT_LANGUAGE);
        userApi.setAuthorities(Collections.singleton(AuthoritiesConstants.ADMIN));

        restMvc.perform(
            post("/api/account")
                .contentType(TestUtil.APPLICATION_JSON_UTF8)
                .content(TestUtil.convertObjectToJsonBytes(userApi)))
            .andExpect(status().isOk());

        User updatedUser = userRepository.findOneByLogin(user.getLogin()).orElse(null);
        assertThat(updatedUser.getFirstName()).isEqualTo(userApi.getFirstName());
        assertThat(updatedUser.getLastName()).isEqualTo(userApi.getLastName());
        assertThat(updatedUser.getEmail()).isEqualTo(userApi.getEmail());
        assertThat(updatedUser.getLangKey()).isEqualTo(userApi.getLangKey());
        assertThat(updatedUser.getPassword()).isEqualTo(user.getPassword());
        assertThat(updatedUser.getImageUrl()).isEqualTo(userApi.getImageUrl());
    ...
    public void testSaveInvalidEmail() throws Exception {
        ...
        userApi.setFirstName("firstname");
        userApi.setLastName("lastname");
        userApi.setEmail("invalid email");
        userApi.setActivated(false);
        userApi.setImageUrl("http://placehold.it/50x50");
        userApi.setLangKey(Constants.DEFAULT_LANGUAGE);
        userApi.setAuthorities(Collections.singleton(AuthoritiesConstants.ADMIN));
    ...
    public void testSaveExistingEmail() throws Exception {
        ...
        userApi.setFirstName("firstname");
        userApi.setLastName("lastname");
        userApi.setEmail("save-existing-email2@example.com");
        userApi.setActivated(false);
        userApi.setImageUrl("http://placehold.it/50x50");
        userApi.setLangKey(Constants.DEFAULT_LANGUAGE);
        userApi.setAuthorities(Collections.singleton(AuthoritiesConstants.ADMIN));
    ...
    public void testSaveExistingEmailAndLogin() throws Exception {
        ...
        userApi.setFirstName("firstname");
        userApi.setLastName("lastname");
        userApi.setEmail("save-existing-email-and-login@example.com");
        userApi.setActivated(false);
        userApi.setImageUrl("http://placehold.it/50x50");
        userApi.setLangKey(Constants.DEFAULT_LANGUAGE);
        userApi.setAuthorities(Collections.singleton(AuthoritiesConstants.ADMIN));
