...
import ar.com.flexibility.examen.app.rest.ProfileInfoController;
...
public class ProfileInfoControllerIntTest {
    ...
    public void setup() {
        ...
        ProfileInfoController profileInfoController = new ProfileInfoController(environment, jHipsterProperties);
        this.restProfileMockMvc = MockMvcBuilders
            .standaloneSetup(profileInfoController)
            .build();
    }
