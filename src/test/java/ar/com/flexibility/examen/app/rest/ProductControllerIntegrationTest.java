...
public class ProductControllerIntegrationTest {
    ...
    public void testAddOk() throws Exception {
        ...
        //when
        MvcResult result = mvc.perform(post(pathUrl).contentType(MediaType.APPLICATION_JSON)
    ...
    public void testAddErrorIdNotNull() throws Exception {
        ...
        //when
        mvc.perform(post(pathUrl).contentType(MediaType.APPLICATION_JSON)
                .content(asJsonString(product)))
                //then
    ...
    public void testUpdateOk() throws Exception {
        ...
        product.setPrice(new BigDecimal(2.50));
        //when
        MvcResult result = mvc.perform(put(pathUrl).contentType(MediaType.APPLICATION_JSON)
                .content(asJsonString(product)))
                //then
                .andExpect(status().isOk())
                .andReturn();
    ...
    public void testUpdateErrorWithoutChanges() throws Exception {
        ...
        //when
        mvc.perform(put(pathUrl).contentType(MediaType.APPLICATION_JSON)
                .content(asJsonString(product)))
                //then
                .andExpect(status().isNotAcceptable());
    }
